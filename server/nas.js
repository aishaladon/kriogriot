...
// arrives. See NAS-FTPS.md for the NAS/hPanel setup steps.
//
// Best-effort by design: the site's own local copy (written by multer before
// this ever runs) is always what's served and always the copy of record, so
// a NAS that is off, unreachable, or not yet configured must never fail an
// upload. Every failure is logged and swallowed here — callers get a result
// object, never a thrown error.
